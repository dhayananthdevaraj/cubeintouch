...
//   // ✅ HTML escape helper — prevents HTML tags in options/questions from breaking the platform
...
//         "subtopic": "Web Technologies - HTML",
//         "questionDescription": "Which HTML tag is used to create a hyperlink?",
//         "hascodeSnippet": false,
//         "codeSnippet": "",
//         "options": ["<link>", "<a>", "<href>", "<url>"],
//         "correctOptionIndex": 1,
//         "tags": "hyperlinks, anchor tag"
//       }
//     ];
...
//   // ✅ Convert JSON format to API format — with HTML escaping applied to all text fields
//   const convertToAPIFormat = (question, qbId, userId) => {
//     // Escape each option text before wrapping in <p> tags
//     const optionsArray = question.options.map(opt => ({
//       text: `<p>${escapeHTML(opt)}</p>`,
//       media: ""
//     }));

//     // Correct answer must also use the escaped version to match
//     const correctAnswer = optionsArray[question.correctOptionIndex]?.text || "";

//     // Escape question description text as well
//     let questionData = `<p>${escapeHTML(question.questionDescription)}</p>`;
    
//     // Code snippets go through $$$examly delimiter — NOT escaped (they render in a code block)
...
import { useState } from "react";
import MCQUploaderPlatform from "./MCQUploaderPlatform";
...
const PLATFORMS = [
  {
    ...
    description: "Upload MCQ questions to Corporate Question Banks",
    icon: "🏢",
    color: "#0d6efd",
    tokenKey: "examly_token_mcq_corporate",
  ...
  },
  {
    ...
    description: "Upload MCQ questions to University Question Banks",
    icon: "🎓",
    color: "#7950f2",
    tokenKey: "examly_token_mcq_university",
    ...
    <div className="qb-access-container">
      <div className="qb-org-selection">
        <div className="qb-org-header">
          ...
          <h1 className="qb-org-title">MCQ Sync</h1>
          <p className="qb-org-subtitle">
            Select your platform to upload MCQ questions
          </p>
        </div>
